            ...
            if (!string.IsNullOrEmpty(verificationRequest.Email) && !string.IsNullOrEmpty(code))
            {
                var emailRequest = new EmailRequest()
                {
                    ...
                    Subject = $"Verification Code {code}",
                                        ...
                                        <div style='color: #191919; max-width: 500px'>
                                            ...
                                            <div style='background-color: #f4f4f4; padding: 1rem 2rem'>
                                                ...
                                                <div style='color: #191919; font-size: 11px'>
                                                    <p>If you did not request this code, it is possible that someone else is trying to access the Silicon Account <span style='color: #0041cd'>{verificationRequest.Email}</span>. This email can't receive replies. For more information, visit the Silicon Help Center.</p>
                                                </div>
                            ...
                            ",
                    PlainText = $"Please verify your account using this verification code: {code}. If you did not request this code, it is possible that someone else is trying to access the Silicon Account {verificationRequest.Email}. This email can't receive replies. For more information, visit the Silicon Help Center."
                };
